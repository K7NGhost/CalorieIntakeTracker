...
const SetupPage = (props: Props) => {
  ...
  const validateForm = (): boolean => {
    ...
    if (
      !formData.weightLb ||
      formData.weightLb < 66 ||
      formData.weightLb > 660
    ) {
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Tell us about yourself to calculate your personalized calorie and
            macro goals
          </p>
        </div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 mb-6">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    step="0.1"
                    className={`bg-neutral-800 border ${
                      errors.weightLb ? "border-red-500" : "border-neutral-700"
                    } rounded-lg px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all`}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    step="0.1"
                    className={`bg-neutral-800 border ${
                      errors.heightFt ? "border-red-500" : "border-neutral-700"
                    } rounded-lg px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all`}
